...
function ENT:PhysicsStationarydebug(phys, deltatime)
...
--	local pos = 90.5 * (self.BusLeaveAccel) * math.pow(t, 2) -- (1/2)at^2 = position
--	local rotAng = 60
...
function ENT:PhysicsSimulate( phys, deltatime )
	...
	elseif self.MoveState == MOVE_STATIONARY_DEBUG then
		self:PhysicsStationarydebug(phys, deltatime)
	end
