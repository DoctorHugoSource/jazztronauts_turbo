...
ENT.VoidModels = {
	...
	"models/props_junk/storage_crate01.mdl",
...
ENT.VoidDistantBarModel = "models/sunabouzu/jazzterrain.mdl"
...
function ENT:Initialize()
	...
	if CLIENT then
		...
		self.VoidBar = ManagedCSEnt("jazz_void_road", self.VoidDistantBarModel)
		self.VoidBar:SetNoDraw(true)
		self.VoidBar:Spawn()
