...
function PLAYER:Loadout()
	...
	if game.SinglePlayer() then
		...
		self.Player:StripWeapon("weapon_stan")
		self.Player:StripWeapon("weapon_hacker")
		self.Player:StripWeapon("weapon_jazz_shardlauncher")
		self.Player:StripWeapon("weapon_jazz_deloreanspawner")
		self.Player:StripWeapon("weapon_run")
		self.Player:StripWeapon("swep_sonicsd")
		self.Player:StripWeapon("weapon_base")
		self.Player:StripWeapon("portal_gun")
