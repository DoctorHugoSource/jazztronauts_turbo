timer.Simple(0, function() -- Gross, but gives all weapons a chance to register themselves first
	...
	cat = "tools",
	name = "Portal Gun",
	desc = "The ultimate Mobility tool Capable of transporting you across an entire map instantly, even including props.",
	thirdparty = true
})
	...
	thirdparty = true
		...
		-- The gmod camera, basically just here in the store to give users the option of deciding to spawn with it or not (less inventory clutter)
